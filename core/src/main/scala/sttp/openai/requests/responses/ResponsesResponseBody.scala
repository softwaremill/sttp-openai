...
object ResponsesResponseBody {
  ...
  // Usage readers
  implicit val completionTokensDetailsRW: SnakePickle.ReadWriter[CompletionTokensDetails] = SnakePickle.macroRW
  implicit val promptTokensDetailsRW: SnakePickle.ReadWriter[PromptTokensDetails] = SnakePickle.macroRW
