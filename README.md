...
```sbt
"com.softwaremill.sttp.openai" %% "core" % "0.3.7"
```
...
//> using dep com.softwaremill.sttp.openai::core:0.3.7
...
```scala
// sbt dependency
"com.softwaremill.sttp.openai" %% "fs2" % "0.3.7"
...
```scala mdoc:compile-only
//> using dep com.softwaremill.sttp.openai::fs2:0.3.7
...
```scala
// sbt dependency
"com.softwaremill.sttp.openai" %% "ox" % "0.3.7"
