...
```sbt
"com.softwaremill.sttp.openai" %% "core" % "0.3.0"
```
...
```scala
// sbt dependency
"com.softwaremill.sttp.openai" %% "fs2" % "0.3.0"
...
```scala
// sbt dependency
"com.softwaremill.sttp.openai" %% "ox" % "0.3.0"
...
```scala
//> using dep com.softwaremill.sttp.openai::ox:0.3.0
